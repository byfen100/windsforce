 ...
 *
 * @copyright    Copyright (C)WindsForce TEAM Since 2012.03.17.(http://www.windsforce.com)
...
特别说明: (用户必读!)
  ...
  + 您使用本程序前,请详细阅读用户授权文档 LICENSE.dyhb.切记!在您认为可以满足授权文档
    中列出的要求时,方可使用 WindsForce,否则,请不要将 WindsForce 安装到您的网络上.

  + 如果您不是从官方地址技术支持论坛 http://www.windsforce.net 或 WindsForce Team 网站
    http://www.windsforce.com 上下载的本程序,很可能获得的不是最新版本.所以安装之前请
    查询上述网址,使用最新的 WindsForce 版本安装.

当前版本: (版本详细升级情况,请查看 /changelog)

  + WindsForce 1.1 商业版(程序无免费版)

  + 本文档最后更新时间 2013-06-04 04:56

  + 有关技术详情的信息,请查看 changelog/WindsForce-1.1.txt
  + 有关常见问题解答的信息,请查看 Faq.dyhb
...
我们的联系的方式:
  ...
  + 寻求技术支持请访问 WindsForce Team 技术论坛(http://www.windsforce.net)的商业用户区,
    如果通过其他方式可能不会予以解答.
