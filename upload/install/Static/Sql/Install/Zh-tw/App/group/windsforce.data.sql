...
(6, 1, 'app', '限時操作清理', 'group@Topicexpiry_Hourly_.php', 1365868816, 1365872400, -1, -1, -1, '0'),
(7, 1, 'app', '定時發布主題', 'group@Publish_Halfhourly_.php', 1365912949, 1365913800, -1, -1, -1, '0	30');
