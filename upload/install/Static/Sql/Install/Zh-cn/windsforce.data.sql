...
(6, 'admin@option', '基本设置', 1, '', 1, 1, 2, 2, 1334071697, 1358158681),
(7, 'admin@database', '数据库', 1, '', 1, 1, 2, 3, 1334394862, 1358225406),
(10, 'admin@app', '应用管理', 1, '', 1, 1, 2, 4, 1338021590, 1338045970),
(8, 'admin@registeroption', '注册与访问控制', 1, '', 2, 1, 2, 2, 1337885123, 1358158681),
(9, 'admin@uploadoption', '上传设置', 1, '', 3, 1, 2, 2, 1337887882, 1358158681),
...
(16, 'admin@secoption', '防灌水设置', 1, '', 4, 1, 2, 2, 1339690018, 1358158681),
(17, 'admin@link', '友情链接', 1, '', 1, 1, 2, 6, 1340357076, 1347204167),
(18, 'admin@programoption', '系统版权', 1, '', 12, 1, 2, 2, 1340376127, 1358158681),
(19, 'admin@district', '地区设置', 1, '', 8, 1, 2, 2, 1340471147, 1358158681),
(20, 'admin@badword', '词语过滤', 1, '', 1, 1, 2, 7, 1340648216, 1358108887),
(21, 'admin@userprofilesetting', '用户栏目', 1, '', 8, 1, 2, 1, 1341116036, 1341116051),
(22, 'admin@pmoption', '短消息', 1, '', 5, 1, 2, 2, 1342407121, 1358158681),
(23, 'admin@loginlog', '登录记录', 1, '', 2, 1, 2, 3, 1342567716, 1358225406),
(24, 'admin@pm', '短消息', 1, '', 2, 1, 2, 6, 1342567990, 1347204167),
(25, 'admin@creditoption', '积分设置', 1, '', 7, 1, 2, 2, 1343028013, 1358158681),
(26, 'admin@dateoption', '时间设置', 1, '', 9, 1, 2, 2, 1343285683, 1358158681),
...
(32, 'admin@mailoption', '邮件设置', 1, '', 6, 1, 2, 2, 1345532803, 1358158681),
(33, 'admin@appeal', '申诉审核', 1, '', 4, 1, 2, 6, 1345941491, 1347204167),
(34, 'admin@languageoption', '国际化', 1, '', 10, 1, 2, 2, 1346231982, 1358158681),
...
(38, 'admin@urloption', 'URL优化', 1, '', 11, 1, 2, 2, 1358158655, 1358158681),
