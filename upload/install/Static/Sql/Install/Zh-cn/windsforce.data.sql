...
(6, '邮箱验证', 'verifyemail', 0, 0, 0, 10, 0, 0, 0, 0, 0, 0, 0),
(7, '发布新鲜事', 'posthomefresh', 4, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0),
(8, '通用评论', 'commoncomment', 4, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0),
(9, '上传附件', 'postattachment', 1, 0, 20, 2, 0, 0, 0, 0, 0, 0, 0);
...
(1, '欢迎来到我们的帮助宝库！', '{site_name} 欢迎你的到来，希望这里能够帮助到你！', 1, 1, 1340045081, 1340213370, 1, 'admin', 1, 'admin', 1, 1),
...
(4, '忘记我的登录密码，怎么办？', '', 1, 1, 1340164050, 1340213393, 1, 'admin', 1, 'admin', 1, 1),
...
(1, '用户须知', 7, 0, 1340187070, 1340171834, 1),
(2, '基本功能操作', 1, 0, 1340187040, 1340162722, 1),
(3, '其他相关问题', 0, 0, 1340524577, 1340162735, 1),
(4, '小组管理秘籍', 0, 0, 0, 1364272723, 1);
...
(2, 1, 'admin', '<div class="feed_addhomefreshcomment"><span class="feed_title">评论了新鲜事&nbsp;<a href="{@commentlink}">{commenttitle}</a></span><div class="feed_content"><div class="feed_quote"><span class="feed_quoteinfo">{commentmessage}</span></div></div><div class="feed_action"><a href="{@commentlink}">回复</a></div></div>', 'a:3:{s:12:"@commentlink";s:40:"home://fresh@?id=1&isolation_commentid=1";s:12:"commenttitle";s:28:"Hello world! 世界你好！";s:14:"commentmessage";s:36:"理想很丰满，现实很骨感！";}', 1355633264);
...
(17, 'admin@link', '友情链接', 1, '', 1, 1, 2, 6, 1340357076, 1363519837, 1),
(18, 'admin@programoption', '系统版权', 1, '', 14, 1, 2, 2, 1340376127, 1363926808, 1),
...
(24, 'admin@pm', '短消息', 1, '', 2, 1, 2, 6, 1342567990, 1363519837, 1),
(25, 'admin@creditoption', '积分设置', 1, '', 7, 1, 2, 2, 1343028013, 1363926808, 1),
(26, 'admin@dateoption', '时间设置', 1, '', 9, 1, 2, 2, 1343285683, 1363926808, 1),
(27, 'admin@styleoption', '界面设置', 1, '', 2, 1, 2, 5, 1343320477, 1344813625, 1),
(28, 'admin@appconfigtool', '应用配置', 1, '', 1, 1, 2, 8, 1343902350, 1351241208, 1),
(29, 'admin@style', '风格管理', 1, '', 3, 1, 2, 5, 1344225253, 1344813625, 1),
(30, 'admin@theme', '模板管理', 1, '', 4, 1, 2, 5, 1344813607, 1344813625, 1),
(31, 'admin@slide', '幻灯片', 1, '', 6, 1, 2, 6, 1345362756, 1363519837, 1),
(32, 'admin@mailoption', '邮件设置', 1, '', 6, 1, 2, 2, 1345532803, 1363926808, 1),
(33, 'admin@appeal', '申诉审核', 1, '', 7, 1, 2, 6, 1345941491, 1363519837, 1),
(34, 'admin@languageoption', '国际化', 1, '', 11, 1, 2, 2, 1346231982, 1363926808, 1),
(35, 'admin@sociatype', '社会化帐号', 1, '', 8, 1, 2, 6, 1347204130, 1363519837, 1),
(36, 'admin@globalcache', '更新缓存', 1, '', 2, 1, 2, 8, 1351132990, 1351241208, 1),
(37, 'admin@attachment', '媒体管理', 1, '', 2, 1, 2, 7, 1358108871, 1363677466, 1),
(38, 'admin@urloption', 'URL优化', 1, '', 12, 1, 2, 2, 1358158655, 1363926808, 1),
(39, 'admin@adminlog', '操作记录', 1, '', 3, 1, 2, 3, 1358225380, 1358225406, 1),
(40, 'admin@searchoption', '搜索设置', 1, '', 10, 1, 2, 2, 1358341587, 1363926808, 1),
(41, 'admin@notice', '用户提醒', 1, '', 3, 1, 2, 6, 1362563445, 1363519837, 1),
(42, 'home', 'Home应用', 1, '', 0, 0, 1, 0, 1362710443, 1362711203, 1),
(43, 'home@spaceadmin@transfer|dotransfer', '积分转账', 1, '', 0, 53, 3, 0, 1362711303, 1362886670, 1),
(44, 'home@pm@pmnew|sendpm', '发送短消息', 1, '', 0, 52, 3, 0, 1362711578, 1362886584, 1),
(45, 'home@ucenter@add_homefresh', '发布新鲜事', 1, '', 0, 50, 3, 0, 1362712136, 1362886478, 1),
(46, 'home@ucenter@add_homefreshcomment', '发布新鲜事评论', 1, '', 0, 50, 3, 0, 1362712190, 1362886537, 1),
(47, 'home@ucenter@view', '查看新鲜事', 1, '', 0, 50, 3, 0, 1362717987, 1362881811, 1),
(48, 'home@attachment@add|normal_upload|flash_upload', '附件上传', 1, '', 0, 51, 3, 0, 1362718551, 1362886449, 1),
(49, 'home@attachment@show', '附件浏览', 1, '', 0, 51, 3, 0, 1362718746, 1362886398, 1),
(50, 'home@ucenter', '个人中心', 1, '', 0, 42, 2, 0, 1362881737, 1362886347, 1),
(51, 'home@attachment', '附件相关', 1, '', 0, 42, 2, 0, 1362886382, 0, 1),
(52, 'home@pm', '短消息', 1, '', 0, 42, 2, 0, 1362886564, 0, 1),
(53, 'home@spaceadmin', '个人后台', 1, '', 0, 42, 2, 0, 1362886652, 0, 1),
(54, 'home@ucenter@update_homefreshgoodnum', '新鲜事赞', 1, '', 0, 50, 3, 0, 1362919518, 0, 1),
(55, 'home@attachment@add_attachmentcomment', '发布附件评论', 1, '', 0, 51, 3, 0, 1363255060, 0, 1),
...
(80, 'group@grouptopicadmin@recommendtopic_dialog|recommendtopic', '帖子推荐', 1, '', 0, 71, 3, 0, 1365342839, 0, 1),
(81, 'group@grouptopic@editcommenttopic_dialog|submit_reply', '回帖编辑', 1, '', 0, 61, 3, 0, 1365616414, 0, 1),
(82, 'group@grouptopicadmin@deletecomment_dialog|deletecomment', '删除回帖', 1, '', 0, 71, 3, 0, 1365616587, 0, 1),
(83, 'group@grouptopicadmin@hidecomment_dialog|hidecomment', '屏蔽或者显示回帖', 1, '', 0, 71, 3, 0, 1365616664, 0, 1),
(84, 'group@grouptopicadmin@stickreplycomment_dialog|stickreplycomment', '回帖置顶', 1, '', 0, 71, 3, 0, 1365616719, 0, 1),
(85, 'group@grouptopicadmin@auditcomment_dialog|auditcomment', '回帖审核', 1, '', 0, 71, 3, 0, 1365689632, 0, 1);
...
('site_description', '风之力APP开发框架 (To Make Prowerful APP.天神下凡APP)'),
('site_url', ''),
('close_site', '0'),
...
('windsforce_company_year', '2012-2013'),
('site_year', '2012-2013'),
('stat_code', ''),
('badword_on', '0'),
('pmsend_regdays', '5'),
...
('windsforce_program_company', '风之力（成都）'),
('image_max_width', '800'),
('slide_duration', '0.3'),
('slide_delay', '5'),
('mail_default', ''),
...
('attachment_categorynum', '8'),
('attachment_dialogcategorynum', '12'),
...
('js_lazyload_on', '0'),
('baselistnum', '10'),
('register_welcome', '尊敬的{static_user_name}，您已经注册成为{site_name}的会员，请您在发表言论时，遵守当地法律法规。如果您有什么疑问可以联系管理员，Email: {admin_email}。\r\n\r\n\r\n{site_name} {static_time}'),
('url_domain', ''),
('online_keeptime', '30'),
('online_mostnum', '0'),
('online_indexmost', '30'),
...
(82, '少将1', '', NULL, 1338404977, 1338884047, 10586212, 11186421, 5, '82.gif', 1),
(83, '少将2', '', NULL, 1338404986, 1338884047, 11186422, 11817411, 5, '83.gif', 1),
(84, '少将3', '', NULL, 1338404993, 1338884047, 11817412, 12479751, 5, '84.gif', 1),
(85, '少将4', '', NULL, 1338405001, 1338884047, 12479752, 13174011, 5, '85.gif', 1),
(86, '少将5', '', NULL, 1338405009, 1338884047, 13174012, 13900761, 5, '86.gif', 1),
(87, '少将6', '', NULL, 1338405017, 1338884047, 13900762, 14460571, 5, '87.gif', 1),
(88, '中将1', '', NULL, 1338405031, 1338884047, 14460572, 15454011, 5, '88.gif', 1),
(89, '中将2', '', NULL, 1338405040, 1338884047, 15454012, 16281651, 5, '89.gif', 1),
(90, '中将3', '', NULL, 1338405055, 1338884047, 16281652, 17144061, 5, '90.gif', 1),
(91, '中将4', '', NULL, 1338405065, 1338884056, 17144062, 18041811, 5, '91.gif', 1),
(92, '中将5', '', NULL, 1338405075, 1338884056, 18041812, 18975471, 5, '92.gif', 1),
(93, '中将6', '', NULL, 1338405086, 1338884056, 18975472, 19945611, 5, '93.gif', 1),
(94, '上将1', '', NULL, 1338405099, 1338884056, 19945612, 20952801, 5, '94.gif', 1),
(95, '上将2', '', NULL, 1338405108, 1338884056, 20952802, 21997611, 5, '95.gif', 1),
(96, '上将3', '', NULL, 1338405117, 1338884056, 21997612, 23080611, 5, '96.gif', 1),
(97, '上将4', '', NULL, 1338405131, 1338884056, 23080612, 24202371, 5, '97.gif', 1),
(98, '上将5', '', NULL, 1338405140, 1338884056, 24202372, 25363461, 5, '98.gif', 1),
(99, '上将6', '', NULL, 1338405149, 1338884056, 25363462, 26564451, 5, '99.gif', 1),
(100, '元帅', '', NULL, 1338405163, 1338884056, 26564452, 26564452, 5, '100.gif', 1);
...
(5, 'generals', '将帅', 1338470428, 1338914433, 1, 0, 1);
...
(4, 'customgroup', '自定义', 1338616034, 0, 1, 0, 1);
...
('userprofile_constellation', 1, '星座', '星座(根据生日自动计算)', 0, 0, 0, 0, 1),
('userprofile_zodiac', 1, '生肖', '生肖(根据生日自动计算)', 0, 0, 0, 0, 1),
('userprofile_telephone', 1, '固定电话', '', 0, 0, 0, 0, 1),
('userprofile_mobile', 1, '手机', '', 0, 0, 0, 0, 1),
('userprofile_idcardtype', 1, '证件类型', '身份证 护照 驾驶证等', 0, 0, 0, 0, 1),
('userprofile_idcard', 1, '证件号', '', 0, 0, 0, 0, 1),
('userprofile_address', 1, '邮寄地址', '', 0, 0, 0, 0, 1),
('userprofile_zipcode', 1, '邮编', '', 0, 0, 0, 0, 1),
('userprofile_nationality', 1, '国籍', '', 0, 0, 0, 0, 1),
('userprofile_birthprovince', 1, '出生省份', '', 0, 1, 1, 0, 1),
('userprofile_birthcity', 1, '出生地', '', 0, 1, 1, 0, 1),
('userprofile_birthdist', 1, '出生县', '出生行政区/县', 0, 1, 1, 0, 1),
('userprofile_birthcommunity', 1, '出生小区', '', 0, 1, 1, 0, 1),
('userprofile_resideprovince', 1, '居住省份', '', 0, 1, 1, 0, 1),
('userprofile_residecity', 1, '居住地', '', 0, 1, 1, 0, 1),
('userprofile_residedist', 1, '居住县', '居住行政区/县', 0, 1, 1, 0, 1),
('userprofile_residecommunity', 1, '居住小区', '', 0, 1, 1, 0, 1),
('userprofile_residesuite', 1, '房间', '小区、写字楼门牌号', 0, 0, 0, 0, 1),
('userprofile_graduateschool', 1, '毕业学校', '', 0, 1, 0, 0, 1),
('userprofile_education', 1, '学历', '', 0, 0, 0, 0, 1),
('userprofile_company', 1, '公司', '', 0, 0, 0, 0, 1),
('userprofile_occupation', 1, '职业', '', 0, 1, 0, 0, 1),
('userprofile_position', 1, '职位', '', 0, 1, 0, 0, 1),
('userprofile_revenue', 1, '年收入', '单位 元', 0, 0, 0, 0, 1),
('userprofile_affectivestatus', 1, '情感状态', '', 0, 1, 0, 0, 1),
('userprofile_lookingfor', 1, '交友目的', '希望在网站找到什么样的朋友', 0, 1, 0, 0, 1),
('userprofile_bloodtype', 1, '血型', '', 0, 0, 0, 0, 1),
('userprofile_height', 1, '身高', '单位 cm', 0, 0, 0, 0, 1),
('userprofile_weight', 1, '体重', '单位 kg', 0, 0, 0, 0, 1),
('userprofile_alipay', 1, '支付宝', '', 0, 0, 0, 0, 1),
('userprofile_icq', 1, 'ICQ', '', 0, 0, 0, 0, 1),
('userprofile_qq', 1, 'QQ', '', 0, 1, 0, 0, 1),
('userprofile_yahoo', 1, 'YAHOO帐号', '', 0, 0, 0, 0, 1),
('userprofile_msn', 1, 'MSN', '', 0, 0, 0, 0, 1),
('userprofile_taobao', 1, '阿里旺旺', '', 0, 0, 0, 0, 1),
('userprofile_site', 1, '个人主页', '', 0, 1, 0, 0, 1),
('userprofile_bio', 1, '自我介绍', '', 0, 0, 0, 0, 1),
('userprofile_interest', 1, '兴趣爱好', '', 0, 1, 0, 0, 1),
('userprofile_field1', 0, '自定义字段1', '', 0, 0, 0, 0, 1),
('userprofile_field2', 0, '自定义字段2', '', 0, 0, 0, 0, 1),
('userprofile_field3', 0, '自定义字段3', '', 0, 0, 0, 0, 1),
('userprofile_field4', 0, '自定义字段4', '', 0, 0, 0, 0, 1),
('userprofile_field5', 0, '自定义字段5', '', 0, 0, 0, 0, 1),
('userprofile_field6', 0, '自定义字段6', '', 0, 0, 0, 0, 1),
('userprofile_field7', 0, '自定义字段7', '', 0, 0, 0, 0, 1),
('userprofile_field8', 0, '自定义字段8', '', 0, 0, 0, 0, 1),
...
('userprofile_windsforce', 1, '风之力', '', 0, 0, 0, 0, 1),
('userprofile_skype', 1, 'Skype', '', 0, 0, 0, 0, 1),
('userprofile_weibocom', 1, '新浪微博', '', 0, 1, 0, 0, 1),
('userprofile_tqqcom', 1, '腾讯微博', '', 0, 1, 0, 0, 1),
('userprofile_diandian', 1, '点点网', '', 0, 0, 0, 0, 1),
('userprofile_kindergarten', 1, '幼儿园', '', 0, 0, 0, 0, 1),
('userprofile_primary', 1, '小学', '', 0, 0, 0, 0, 1),
('userprofile_juniorhighschool', 1, '初中', '', 0, 0, 0, 0, 1),
('userprofile_highschool', 1, '高中', '', 0, 0, 0, 0, 1),
('userprofile_university', 1, '大学', '', 0, 0, 0, 0, 1),
('userprofile_master', 1, '硕士', '', 0, 0, 0, 0, 1),
('userprofile_dr', 1, '博士', '', 0, 0, 0, 0, 1),
('userprofile_nowschool', 1, '当前学校', '', 0, 0, 0, 0, 1);

-- --------------------------------------------------------

--
-- 转存表中的数据 `windsforce_userrole`
--
