...
(4, 1, 'system', '清理过期动态', 'Cleanfeed_.php', 1365868835, 1365955200, -1, -1, 0, '0');
...
(48, 'home@attachment@add|normal_upload', '附件上传', 1, '', 0, 51, 3, 0, 1362718551, 1362886449, 1),
...
('windsforce_program_version', '1.1.1'),
