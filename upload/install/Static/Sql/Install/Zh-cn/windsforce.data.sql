...
(6, 'admin@option', '基本设置', 1, '', 1, 1, 2, 2, 1334071697, 1358341614, 1),
(7, 'admin@database', '数据库', 1, '', 1, 1, 2, 3, 1334394862, 1358225406, 1),
(10, 'admin@app', '应用管理', 1, '', 1, 1, 2, 4, 1338021590, 1338045970, 1),
(8, 'admin@registeroption', '注册与访问控制', 1, '', 2, 1, 2, 2, 1337885123, 1358341614, 1),
(9, 'admin@uploadoption', '上传设置', 1, '', 3, 1, 2, 2, 1337887882, 1358341614, 1),
...
(16, 'admin@secoption', '防灌水设置', 1, '', 4, 1, 2, 2, 1339690018, 1358341614, 1),
(17, 'admin@link', '友情链接', 1, '', 1, 1, 2, 6, 1340357076, 1363516442, 1),
(18, 'admin@programoption', '系统版权', 1, '', 13, 1, 2, 2, 1340376127, 1358341614, 1),
(19, 'admin@district', '地区设置', 1, '', 8, 1, 2, 2, 1340471147, 1358341614, 1),
(20, 'admin@badword', '词语过滤', 1, '', 1, 1, 2, 7, 1340648216, 1358108887, 1),
(21, 'admin@userprofilesetting', '用户栏目', 1, '', 8, 1, 2, 1, 1341116036, 1341116051, 1),
(22, 'admin@pmoption', '短消息', 1, '', 5, 1, 2, 2, 1342407121, 1358341614, 1),
(23, 'admin@loginlog', '登录记录', 1, '', 2, 1, 2, 3, 1342567716, 1358225406, 1),
(24, 'admin@pm', '短消息', 1, '', 2, 1, 2, 6, 1342567990, 1363516442, 1),
(25, 'admin@creditoption', '积分设置', 1, '', 7, 1, 2, 2, 1343028013, 1358341614, 1),
(26, 'admin@dateoption', '时间设置', 1, '', 9, 1, 2, 2, 1343285683, 1358341614, 1),
...
(31, 'admin@slide', '幻灯片', 1, '', 5, 1, 2, 6, 1345362756, 1363516442, 1),
(32, 'admin@mailoption', '邮件设置', 1, '', 6, 1, 2, 2, 1345532803, 1358341614, 1),
(33, 'admin@appeal', '申诉审核', 1, '', 6, 1, 2, 6, 1345941491, 1363516442, 1),
(34, 'admin@languageoption', '国际化', 1, '', 11, 1, 2, 2, 1346231982, 1358341614, 1),
(35, 'admin@sociatype', '社会化帐号', 1, '', 7, 1, 2, 6, 1347204130, 1363516442, 1),
(36, 'admin@globalcache', '更新缓存', 1, '', 2, 1, 2, 8, 1351132990, 1351241208, 1),
(37, 'admin@attachment', '媒体管理', 1, '', 2, 1, 2, 7, 1358108871, 1358108887, 1),
(38, 'admin@urloption', 'URL优化', 1, '', 12, 1, 2, 2, 1358158655, 1358341614, 1),
(39, 'admin@adminlog', '操作记录', 1, '', 3, 1, 2, 3, 1358225380, 1358225406, 1),
(40, 'admin@searchoption', '搜索设置', 1, '', 10, 1, 2, 2, 1358341587, 1358341614, 1),
(41, 'admin@notice', '用户提醒', 1, '', 3, 1, 2, 6, 1362563445, 1363516442, 1),
...
(56, 'admin@feed', '用户动态', 1, '', 4, 1, 2, 6, 1363516426, 1363516442, 1);
...
(1, 'admin', '', 'cd5be146ca5cc5985943ef02bd61f70d', '127.0.0.1', 1355150636, '::1', 1, 'admin@windsforce.com', '', '每天都需要可以！', 1333281705, '', 1, '90ad77', '', '0', '', 0, 0);
