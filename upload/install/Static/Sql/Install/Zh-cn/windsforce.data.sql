...
(6, 'admin@option', '基本设置', 1, '', 1, 1, 2, 2, 1334071697, 1358341614),
(7, 'admin@database', '数据库', 1, '', 1, 1, 2, 3, 1334394862, 1358225406),
(10, 'admin@app', '应用管理', 1, '', 1, 1, 2, 4, 1338021590, 1338045970),
(8, 'admin@registeroption', '注册与访问控制', 1, '', 2, 1, 2, 2, 1337885123, 1358341614),
(9, 'admin@uploadoption', '上传设置', 1, '', 3, 1, 2, 2, 1337887882, 1358341614),
...
(16, 'admin@secoption', '防灌水设置', 1, '', 4, 1, 2, 2, 1339690018, 1358341614),
(17, 'admin@link', '友情链接', 1, '', 1, 1, 2, 6, 1340357076, 1347204167),
(18, 'admin@programoption', '系统版权', 1, '', 13, 1, 2, 2, 1340376127, 1358341614),
(19, 'admin@district', '地区设置', 1, '', 8, 1, 2, 2, 1340471147, 1358341614),
(20, 'admin@badword', '词语过滤', 1, '', 1, 1, 2, 7, 1340648216, 1358108887),
(21, 'admin@userprofilesetting', '用户栏目', 1, '', 8, 1, 2, 1, 1341116036, 1341116051),
(22, 'admin@pmoption', '短消息', 1, '', 5, 1, 2, 2, 1342407121, 1358341614),
(23, 'admin@loginlog', '登录记录', 1, '', 2, 1, 2, 3, 1342567716, 1358225406),
(24, 'admin@pm', '短消息', 1, '', 2, 1, 2, 6, 1342567990, 1347204167),
(25, 'admin@creditoption', '积分设置', 1, '', 7, 1, 2, 2, 1343028013, 1358341614),
(26, 'admin@dateoption', '时间设置', 1, '', 9, 1, 2, 2, 1343285683, 1358341614),
...
(32, 'admin@mailoption', '邮件设置', 1, '', 6, 1, 2, 2, 1345532803, 1358341614),
(33, 'admin@appeal', '申诉审核', 1, '', 4, 1, 2, 6, 1345941491, 1347204167),
(34, 'admin@languageoption', '国际化', 1, '', 11, 1, 2, 2, 1346231982, 1358341614),
(35, 'admin@sociatype', '社会化帐号', 1, '', 5, 1, 2, 6, 1347204130, 1347204167),
(36, 'admin@globalcache', '更新缓存', 1, '', 2, 1, 2, 8, 1351132990, 1351241208),
(37, 'admin@attachment', '媒体管理', 1, '', 2, 1, 2, 7, 1358108871, 1358108887),
(38, 'admin@urloption', 'URL优化', 1, '', 12, 1, 2, 2, 1358158655, 1358341614),
(39, 'admin@adminlog', '操作记录', 1, '', 3, 1, 2, 3, 1358225380, 1358225406),
(40, 'admin@searchoption', '搜索设置', 1, '', 10, 1, 2, 2, 1358341587, 1358341614),
(41, 'admin@notice', '用户提醒', 1, '', 3, 1, 2, 6, 1362563445, 1362563466);
...
('userprofile_gender', 1, '性别', '', 0, 1, 1, 0),
('userprofile_birthyear', 1, '出生年份', '', 0, 1, 1, 0),
('userprofile_birthmonth', 1, '出生月份', '', 0, 1, 1, 0),
('userprofile_birthday', 1, '生日', '', 0, 1, 1, 0),
...
('userprofile_birthprovince', 1, '出生省份', '', 0, 1, 1, 0),
('userprofile_birthcity', 1, '出生地', '', 0, 1, 1, 0),
('userprofile_birthdist', 1, '出生县', '出生行政区/县', 0, 1, 1, 0),
('userprofile_birthcommunity', 1, '出生小区', '', 0, 1, 1, 0),
('userprofile_resideprovince', 1, '居住省份', '', 0, 1, 1, 0),
('userprofile_residecity', 1, '居住地', '', 0, 1, 1, 0),
('userprofile_residedist', 1, '居住县', '居住行政区/县', 0, 1, 1, 0),
('userprofile_residecommunity', 1, '居住小区', '', 0, 1, 1, 0),
('userprofile_residesuite', 1, '房间', '小区、写字楼门牌号', 0, 0, 0, 0),
('userprofile_graduateschool', 1, '毕业学校', '', 0, 1, 0, 0),
('userprofile_education', 1, '学历', '', 0, 0, 0, 0),
('userprofile_company', 1, '公司', '', 0, 0, 0, 0),
('userprofile_occupation', 1, '职业', '', 0, 1, 0, 0),
('userprofile_position', 1, '职位', '', 0, 1, 0, 0),
('userprofile_revenue', 1, '年收入', '单位 元', 0, 0, 0, 0),
('userprofile_affectivestatus', 1, '情感状态', '', 0, 1, 0, 0),
('userprofile_lookingfor', 1, '交友目的', '希望在网站找到什么样的朋友', 0, 1, 0, 0),
...
('userprofile_weibocom', 1, '新浪微博', '', 0, 1, 0, 0),
('userprofile_tqqcom', 1, '腾讯微博', '', 0, 1, 0, 0),
