...
(9, '我如何使用WindsForce!代码', '<p>\n	系统支持有两种不能功能用途的代码：\n</p>\n<p>\n	<a href="index.php?app=home&amp;c=misc&amp;a=ubb" target="_blank">基本的UBB代码</a>和<a href="index.php?app=home&amp;c=misc&amp;a=ubb&amp;type=sign" target="_blank">签名UBB代码</a>\n</p>', 3, 1, 1363704817, 1363756863, 1, 'admin', 1, 'admin', 2, 0);
