...
(8, '评论新鲜事', 'commenthomefresh', 4, 0, 0, 2, 0, 0, 0, 0, 0, 0, 0),
...
(17, 'admin@link', '友情链接', 1, '', 1, 1, 2, 6, 1340357076, 1362563466, 1),
...
(24, 'admin@pm', '短消息', 1, '', 2, 1, 2, 6, 1342567990, 1362563466, 1),
...
(31, 'admin@slide', '幻灯片', 1, '', 4, 1, 2, 6, 1345362756, 1362563466, 1),
(32, 'admin@mailoption', '邮件设置', 1, '', 6, 1, 2, 2, 1345532803, 1358341614, 1),
(33, 'admin@appeal', '申诉审核', 1, '', 5, 1, 2, 6, 1345941491, 1362563466, 1),
(34, 'admin@languageoption', '国际化', 1, '', 11, 1, 2, 2, 1346231982, 1358341614, 1),
(35, 'admin@sociatype', '社会化帐号', 1, '', 6, 1, 2, 6, 1347204130, 1362563466, 1),
...
(41, 'admin@notice', '用户提醒', 1, '', 3, 1, 2, 6, 1362563445, 1362563466, 1),
