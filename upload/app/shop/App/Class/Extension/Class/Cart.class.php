...
class Cart{
	...
	protected $_sCookiename='wfcart_cookie';
	...
	public function save(){
		$arrCarts=$this->_arrCarts;
		Dyhb::cookie($this->_sCookiename,serialize($arrCarts),$this->_nExpires);
	}
	...
	public function setCookiename($sCookiename='wfcart_cookie'){
