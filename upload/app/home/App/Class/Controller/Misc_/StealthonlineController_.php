...
class StealthonlineController extends Controller{
	...
	public function index(){
		if($GLOBALS['___login___']===false){
			$this->E(Dyhb::L('未登录用户无法转换在线状态','Controller'));
		}
		...
		$this->S($nUn==1?Dyhb::L('设置状态为在线成功','Controller'):Dyhb::L('设置状态为隐身成功','Controller'));
	}
