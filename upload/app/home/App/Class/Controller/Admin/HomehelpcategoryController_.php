	...
	public function bForeverdelete_(){
		...
		foreach($arrIds as $nId){
			if($this->is_system_homehelpcategory($nId)){
				$this->E(Dyhb::L('系统站点帮助分类无法删除','__APPHOME_COMMON_LANG__@Controller'));
			}
			...
			if($nHomehelps>0){
				$this->E(Dyhb::L('站点帮助分类%s存在帮助内容，你无法删除','__APPHOME_COMMON_LANG__@Controller',null,$oHomehelpcategory->homehelpcategory_name));
			}
		}
	}
