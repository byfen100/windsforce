		...
		return array(
			...
			'check'=>array(
				'grouptopictag_name'=>array(
					array('require',Dyhb::L('帖子标签不能为空','__APPGROUP_COMMON_LANG__@Model/Grouptopictag')),
					array('max_length',32,Dyhb::L('帖子标签不能超过32个字符','__APPGROUP_COMMON_LANG__@Model/Grouptopictag')),
				),
			),
		);
	}
