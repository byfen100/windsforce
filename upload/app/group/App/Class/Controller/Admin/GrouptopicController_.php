...
class GrouptopicController extends InitController{
	...
	public function add(){
		$this->E(Dyhb::L('后台无法发布帖子','__APPGROUP_COMMON_LANG__@Controller').'<br/><a href="'.Core_Extend::windsforceOuter('app=group&c=grouptopic&a=add').'" target="_blank">'.Dyhb::L('前往发布','__APPGROUP_COMMON_LANG__@Controller').'</a>');
	}
