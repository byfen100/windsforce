...
class StatuscommentController extends Controller{
	...
	public function index(){
		...
		$this->A(array('group_id'=>$nGroupid,'grouptopic_url'=>$sGrouptopicurl),$nStatus==0?Dyhb::L('屏蔽回帖成功','Controller/Grouptopicadmin'):Dyhb::L('取消屏蔽回帖成功','Controller/Grouptopicadmin'));
	}
