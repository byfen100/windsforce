(function($){
	...
	hoverCardBuilder=function(hoverObject,opts){
		//设置名片显示位置nTop,nLeft
		var nTop=hoverObject.offset().top + hoverObject.height()-6,nLeft=hoverObject.offset().left-104+ hoverObject.width()/2;
	...
	$.fn.hoverCard.defaults={
		...
		borederRadius:false,
		errorText:"读取错误",
		placeHolder:_ROOT_+"/Public/js/jquery/hovercard/images/loading.gif"
	};
})(jQuery);
